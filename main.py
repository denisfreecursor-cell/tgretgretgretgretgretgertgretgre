...
async def show_instruction_detail(callback: CallbackQuery):
    ...
    instructions = {
        "tiktok_comments": (
            ...
            "1️⃣ Откройте приложение TikTok\n"
            "2️⃣ Найдите указанное видео\n"
            "3️⃣ Напишите комментарий согласно заданию\n"
            "4️⃣ Сделайте скриншот опубликованного комментария\n\n"
            "⚠️ <b>Важно:</b>\n"
            "• Комментарий должен быть виден на скриншоте\n"
            "• Скриншот должен быть четким\n"
            "• Не используйте запрещенные слова"
        ),
        "tiktok_video": (
