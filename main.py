...
"tiktok_comments": (
    ...
    "• Можете поставить ник с призывом купить в LuxtoreVape и оставить любой комментарий даже смайлик .\n\n"
    "🖼️ <b>Дополнительно:</b>\n"
    ...
    "📋 <b>Отчёт:</b>\n"
    "• Приложите скриншот вашего комментария под видео, чтоб было видно и скриншот и видео.\n\n"
    "⚠️ <b>Важно:</b>\n"
    ...
    "Ваша задача — создавать <b>интересные и уникальные видео</b> на тему вейпов и Казахстана 💨\n"
    "Главная цель — привлекать внимание и показывать магазин естественно и ненавязчиво.\n\n"
    "🚀 <b>Как действовать:</b>\n"
    "1️⃣ Снимайте видео на тему вейпов, одноразок или магазинов в Казахстане 🇰🇿\n"
    "2️⃣ В видео обязательно упоминайте @LuxtoreVape — это может быть в тексте, на экране или устно.\n"
    "3️⃣ В профиле TikTok должна быть активная ссылка на магазин.\n"
    "4️⃣ Сделайте видео интересным и креативным — обзоры, сценки, мемы и т.д., но без агрессивной рекламы.\n"
    "5️⃣ Сделайте скриншоты опубликованного видео и вашего профиля с видимой ссылкой.\n\n"
    "📋 <b>Отчёт:</b>\n"
    "• Скриншоты видео и профиля с ссылкой.\n\n"
    "⚠️ <b>Важно:</b>\n"
    "• Видео должно быть уникальным, интересным и соответствовать теме.\n"
    "• Реклама ненавязчивая — только естественное упоминание @LuxtoreVape.\n"
    "• Ссылка на магазин в профиле обязательна.\n"
    "• Хештеги значения не имеют — можно не добавлять."
),

       "threads_comments": (
    "💬 <b>Инструкция: Threads Комментарии</b>\n\n"
    "Ваша цель — активно продвигать @LuxtoreVape (Telegram) под постами, связанными с <b>Казахстаном и темой вейпов</b> 💨\n"
    "Будьте заметными, пишите уверенно и прямо — главное, чтобы коммент выглядел живо и вызывал интерес 💥\n\n"
    "🔍 <b>Что искать:</b>\n"
    "• Посты с упоминанием «вейп», «одноразка», «Казахстан», «VAKA» и т.п.\n"
    "• Контент, связанный с Казахстаном — приоритет 🇰🇿\n"
    "• Российские посты и обсуждения — не засчитываются.\n\n"
    "💬 <b>Как комментировать:</b>\n"
    "• Обязательно упоминайте <b>@LuxtoreVape (Telegram)</b> в каждом комментарии.\n"
    "• Можно писать дерзко, уверенно, с эмоцией — но без откровенного мата.\n"
    "• Разрешены прямые фразы вроде: «Лучшие одноразки только у @LuxtoreVape», «Не парь фигню — бери у @LuxtoreVape» и т.д.\n"
    "• Можете спорить, шутить, задавать вопросы — главное, чтобы коммент цеплял внимание ⚡️\n\n"
    "🖼️ <b>Дополнительно:</b>\n"
    "• Разрешено прикреплять картинки или мемы с надписью @LuxtoreVape (Telegram).\n"
    "• Чем ярче и заметнее — тем лучше 🔥\n\n"
    "📋 <b>Отчёт:</b>\n"
    "• Приложите скриншот с вашим комментарием (он должен быть чётко виден) и чтоб было видно пост.\n\n"
    "⚠️ <b>Важно:</b>\n"
    "• Не перебарщивайте с оскорблениями — агрессивно ≠ токсично.\n"
    "• Коммент должен быть энергичным, но не нарушать правила платформы."
),
"threads_threads": (
    "🧵 <b>Инструкция: Threads Ветки</b>\n\n"
    "Ваша задача — создавать активные ветки в Threads, связанные с <b>Казахстаном и темой вейпов</b> 💨\n"
    "Посты должны быть живыми, провокационными и вызывать обсуждения. Цель — привлечь внимание и перевести аудиторию к нам 👉 <b>@LuxtoreVape</b> 🔥\n\n"
    "🚀 <b>Как действовать:</b>\n"
    "1️⃣ Создайте новую ветку (тред) на тему вейпов, одноразок или магазинов в Казахстане 🇰🇿\n"
    "2️⃣ В тексте обязательно добавляйте <b>упоминание и/или ссылку</b> на нас:\n"
    "   • Пример: «Лучшие одноразки только у 👉 <b>@LuxtoreVape</b>»\n"
    "   • Или добавьте ссылку в свой профиль и напишите: «Ссылка в профиле 🔗»\n"
    "3️⃣ Пишите уверенно, можно дерзко — провоцируйте диалог, задавайте вопросы, сравнивайте бренды ⚡️\n"
    "4️⃣ Прикрепляйте фото, мемы или короткие видео с логотипом и надписью <b>@LuxtoreVape</b> — чем ярче, тем лучше 💥\n\n"
    "📋 <b>Отчёт:</b>\n"
    "• Добавьте скриншоты поста и вашего профиля, где видно ссылку или упоминание @LuxtoreVape.\n\n"
    "⚠️ <b>Важно:</b>\n"
    "• Контент должен быть уникальным и не скопированным.\n"
    "• Разрешён уверенный, агрессивный стиль — без оскорблений.\n"
    "• Ссылка или упоминание @LuxtoreVape должна быть <b>обязательной</b> частью поста или профиля.\n"
    "• Главная цель — создавать активные обсуждения и направлять трафик к @LuxtoreVape (Telegram)."
),
}
...
async def show_info(callback: CallbackQuery):
    ...
    await callback.message.edit_text(
        text=(
            "💸 <b>Зарабатывай с TikTok и Threads!</b>\n\n"
            "Вы можете получать оплату, <b>оставляя комментарии</b> или <b>создавая публикации</b> в TikTok и Threads.\n\n"
            "💬 <b>TikTok</b>\n"
            "• За <b>100 комментариев</b> — 1000₽\n"
            "• Если ваше <b>видео набирает 1000 просмотров</b> — 1500₽\n\n"
            "🧵 <b>Threads</b>\n"
            "• За <b>100 комментариев</b> — 1200₽\n"
            "• Если ваша <b>ветка набирает 500 просмотров</b> — 850₽\n\n"
            "💡 <b>Важно:</b> оплата идёт <b>за каждые 500 или 1000 просмотров</b>, то есть:\n"
            "Если ваша ветка в Threads набирает 2000 просмотров → 850₽ × 4 = 3400₽\n\n"
            "⚠️ <b>Минимальные требования для выплат:</b>\n"
            "• TikTok комментарии: от 100\n"
            "• TikTok видео: от 1000 просмотров\n"
            "• Threads комментарии: от 100\n"
            "• Threads ветки: от 500 просмотров\n\n"
            "💡 <b>Обратите внимание:</b>\n"
            "• За ветку или видео выплату можно получить <b>только один раз</b>\n"
            "• Можно совмещать: оставлять комментарии и создавать видео одновременно\n"
            "• Отчет проверяется до 24 часов\n\n"
            "Перед тем как приступить к работе, ознакомьтесь с инструкциями и требованиями.\n"
            "Если будут вопросы — обратитесь к администратору."
        ),
        reply_markup=back_to_main_keyboard(),
        parse_mode="HTML"
    )
